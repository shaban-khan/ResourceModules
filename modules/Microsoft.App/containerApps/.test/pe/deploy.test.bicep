...
module nestedDependencies 'dependencies.bicep' = {
  ...
  params: {
    location: location
    managedIdentityName: 'skhan88-msi-${serviceShort}'
    managedEnvironmentName: 'skhan88-menv-${serviceShort}'
    virtualNetworkName: 'skhan88-vnet-${serviceShort}'
    logAnalyticsWorkspaceName: 'dep-skhan88-law-${serviceShort}'
  }
}
